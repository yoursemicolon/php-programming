...
<body>
    ...
    <?php foreach($products as $product) : ?>
        <ul>
            <img src="img/<?php echo $product["gambar"]; ?>" alt="<?php echo $product["gambar"]; ?>" width="200px">
            <li>Nama: <?= $product["nama"]; ?></li>
            <li>Kategori: <?= $product["kategori"]; ?></li>
            <li>Harga: <?= $product["harga"]; ?></li>
            <li>Stok lainnya: <?= $product["stok barang"]; ?></li>
            <li>Stok diskon: <?= $product["stok diskon"]; ?></li>
            <li>Masa penyimpanan: <?= $product["masa penyimpanan"]; ?></li><br>
        </ul>
    <?php endforeach; ?>
</body>
</html>